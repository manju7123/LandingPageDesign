        ...
        return(
            <nav className="navbar">
                ...
                <div className="menu-left-card">
                    ...
                    <svg className="logo-image" width="96" height="32" viewBox="0 0 97 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="menu-links-card">
                        <h1 className="menu-link"> Explore </h1>
                        <h1 className="menu-link"> Company </h1>
                        <h1 className="menu-link"> Support </h1>
                    </div>
                </div>
                <div className="menu-right-card">
                    <p className="menu-right-para">Become a member</p>
                    <button className="btn-primary sign-button">Sign in</button>
                </div>
                <div className="menu-mobile-right-card">
...
<circle cx="19" cy="19" r="1" fill="#2B2730"/>
                ...
                {
                    menuButton&&(
                        <div className="menu-mobile-links-card">
                <h1 className="menu-mobile-links"> Explore </h1>
                        <h1 className="menu-mobile-links"> Company </h1>
                        <h1 className="menu-mobile-links"> Support </h1>
                        <button className="btn-primary sign-mobile-button">Sign in</button>
                </div>
                    )
                }
            </nav>
